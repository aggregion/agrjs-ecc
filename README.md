...
-   Html script tag, see [releases](https://github.com/AGRIO/agrjs-ecc/releases) for the correct **version** and its matching script **integrity** hash.
...
-   `wif` **[wif](#wif)** 
-   `pubkey_prefix` **[string](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)** public key prefix (optional, default `'AGR'`)
...
-   `pubkey` **[pubkey](#pubkey)** like AGRKey..
-   `pubkey_prefix` **[string](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)**  (optional, default `'AGR'`)
...
-   `signature` **([String](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String) \| [Buffer](https://nodejs.org/api/buffer.html))** (AGRbase58sig.., Hex, Buffer)
