...
/**
  ...
  @param {string} [pubkey_prefix = 'AGR']
*/
function PublicKey(Q, pubkey_prefix = 'AGR') {
    if(typeof Q === 'string') {
    ...
    */
    function toString(pubkey_prefix = 'AGR') {
...
/**
  ...
  @param {string} [pubkey_prefix = 'AGR']
*/
PublicKey.isValid = function(pubkey, pubkey_prefix = 'AGR') {
    try {
...
*/
PublicKey.fromString = function(public_key, pubkey_prefix = 'AGR') {
    try {
...
/**
    ...
    @return PublicKey
*/
PublicKey.fromStringOrThrow = function(public_key, pubkey_prefix = 'AGR') {
