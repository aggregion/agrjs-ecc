...
describe('Common API', () => {
  ...
  it('privateToPublic', () => {
    ...
    const pub = 'AGR859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM'
  ...
  it('isValidPublic', () => {
    const keys = [
      ...
      [true, 'AGR859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM'],
      [false, 'MMM859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM'],
      [false, 'AGR859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVm', 'AGR'],
